...
public class MyBase_YLL extends BaseAdapter {

    private Context context;
    private List<MyGson_YL.NewslistBean> newslist;

    public MyBase_YLL(Context context, List<MyGson_YL.NewslistBean> newslist) {
